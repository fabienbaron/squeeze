...
double fill_iframeburned(long *iframeburned, long depth, long threadnum, long nelements, long niter, double *saved_lPosterior, double *saved_lLikelihood,
                         double *saved_reg_value);
...
void compute_logZ(const double *temperature, const unsigned short *iStoragetoThread, const double *lLikelihood_expectation, const double *lLikelihood_deviation,
                  int nchains, double *logZ, double *logZ_err);

void mcmc_fullchain(char *file, long nchains, long niter, int nchanr, long nelements, unsigned short axis_len, unsigned short *saved_x, unsigned short *saved_y,
...
void compute_regularizers(const double *reg_param, double *reg_value, const double *image, const double *prior_image, const double regflux,
